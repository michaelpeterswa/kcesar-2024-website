...
export default function History() {
  ...
  return (
    <BasicLayout>
      ...
      />
      <BasicImage
        location="/kcesar/history/1972Gridding02.jpg"
        alt="Rescuers preparing for a day of training"
      />
      <CenteredText
      ...
      />
      <CenteredText
        content="1956 marked ESAR's first request for service by the Seattle Police.  In 1957, 
